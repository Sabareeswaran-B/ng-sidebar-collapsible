...
//       { type: NodeDependencyType.Default, version: '~1.1.0', name: 'ng-sidenav' }
//     ];
...
function addModuleToImports(options: any): Rule {
  return (host: Tree) => {
    ...
    const moduleName = 'NgSidenavModule';

    addModuleImportToRootModule(host, moduleName, 'ng-sidenav', project as WorkspaceProject<ProjectType.Application>);
